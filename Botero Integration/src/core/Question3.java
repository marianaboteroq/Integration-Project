...
public class Question3 {
  ...
  public static void askingGenre() {
    ...
    /*
     * creating boolean variables to compare two strings, disregarding case sensitivity the equals
     * method is used to compare the similarity of two objects, as == will merely compare the
     * location of those objects and not the similarity like equals() source:
    ...
    if (varA == 0) { // if user input is the same as the "satire" genre
      ...
      switch (newFavGenre) {
        case "fantasy":
          ...
          // points
          break; /*
                  * if newFavGenre (user input) corresponds to this specific case ("fantasy"),
                  * control will pass to statement outside of the loop.
                  */
        case "romance":
          System.out
              .println("You picked romance, jot down " + ((Math.pow(2, 5)) * 2) + " points.\n");
          // 64
          // points
          break;
        case "memoir":
          System.out
              .println("You picked memoir, jot down " + ((Math.pow(2, 7)) - 2) + " points.\n");
          // 126
          // points
          break;
        case "science":
          System.out
              .println("You picked science, jot down " + ((Math.pow(2, 7)) % 3) + " points.\n");
          // 2
          // points
          break;
        case "spirituality":
