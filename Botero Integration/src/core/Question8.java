...
public class Question8 {
  public static void askingFavNum() {
    ...
    for (int x : favNum) {
      System.out.printf(x + ", ");
      if (x == 91) {
        break; // used break statement to break out of the for loop, so the last number (3) would
               // not have a comma since it is the last number in the row, and does not need a comma
      }
    }
    System.out.printf("3");
